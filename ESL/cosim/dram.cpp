...
{
    dram_ctrl_in1_socket.register_b_transport(this, &DRAM::b_transport);
    dram_ctrl_in2_socket.register_b_transport(this, &DRAM::b_transport);
    dram_ctrl_out1_socket.register_b_transport(this, &DRAM::b_transport);
    dram_ctrl_out2_socket.register_b_transport(this, &DRAM::b_transport);
